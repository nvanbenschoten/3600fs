...
int getNODE(dnode *directory, char *name, dnode *searchDnode, inode *searchInode, blocknum *block, int deleteFlag, int directoryBlock, int renameFlag, const char *newName);
